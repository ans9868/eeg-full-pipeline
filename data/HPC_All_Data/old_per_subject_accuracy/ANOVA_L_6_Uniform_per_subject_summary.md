...
- **N Folds Observed**: Number of times the subject appeared in a test fold
- **NA**: Subject not observed in any test fold

| Subject | Median Accuracy | N Folds Observed |
|---------|----------------|------------------|
| sub-1 | 71.97% | 1 |
| sub-2 | 71.97% | 1 |
| sub-3 | 71.97% | 1 |
...
- **Median accuracy (across subjects)**: 67.56%
- **Mean accuracy (across subjects)**: 67.75%
- **Min accuracy**: 52.53%
- **Max accuracy**: 83.66%
