#!/usr/bin/env python3
"""
Simple graph generator that works without a config file.
"""
...
class SimplePerSubjectAnalysisGraph:
    ...
    def __init__(self, output_dir: Path):
        ...
        print(f"Initialized SimplePerSubjectAnalysisGraph")
...
def main():
    print("🚀 Starting simple_graph_generator_no_config.py")
    print(f"📋 Arguments: {sys.argv}")
    
    if len(sys.argv) < 2:
        print("Usage: python simple_graph_generator_no_config.py <ml_results_path>")
        print("Example: python simple_graph_generator_no_config.py /path/to/ml_results")
        sys.exit(1)
    ...
    try:
        ...
        per_subject_graph = SimplePerSubjectAnalysisGraph(output_dir=output_dir)
