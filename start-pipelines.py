            ...
            if smoke_source == "raw-waveform":
                ...
                return " ".join(
                    [
                        ...
                        str(smoke_config.get("max_rows", 512)),
                        "--label-column",
                        str(smoke_config.get("label_column", "label")),
                        "--epochs",
                        ...
                        "--conformer-patch-size",
                        str(smoke_config.get("conformer_patch_size", 16)),
                        "--conformer-depth",
                        str(smoke_config.get("conformer_depth", 2)),
                        "--conformer-dropout",
                        str(smoke_config.get("conformer_dropout", 0.1)),
                        "--models",
                        ",".join(smoke_config.get("models", ["eegnet_feature_smoke", "transformer_feature_smoke"])),
                        "--splits",
                        ",".join(smoke_config.get("splits", ["subject_disjoint_smoke", "subject_overlap_smoke"])),
                        "--validation-split",
